...
np.savez("Test_Exp\\exp0.npz", exp_dataX_list[5], exp_label_list[0])

print('exp0 size:', len(exp_label_list[0]))

np.savez("Test_Exp\\exp0.npz", exp_dataX_list[6], exp_label_list[0])

print('exp0 size:', len(exp_label_list[0]))

np.savez("Test_Exp\\exp0.npz", exp_dataX_list[7], exp_label_list[0])
