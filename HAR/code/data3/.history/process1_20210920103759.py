...
np.savez("Test_Exp\\exp0.npz", exp_dataX_list[5], exp_label_list[5])

print('exp0 size:', len(exp_label_list[5]))

np.savez("Test_Exp\\exp0.npz", exp_dataX_list[6], exp_label_list[6])

print('exp6 size:', len(exp_label_list[6]))

np.savez("Test_Exp\\exp0.npz", exp_dataX_list[7], exp_label_list[7])
